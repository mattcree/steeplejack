...
Levels and test maps are **generated by script**, never hand-built in the editor. That is what keeps
the project agent-executable, and it is the same reason `data/levels/*.json` exists.
