...
6. The editor opens an empty map with both modules loaded and no errors.
...
| 6 | Editor opens an empty map, modules loaded, no errors | PASS — 8.05 s, zero errors, `SteeplejackGame` loaded, all ten plugins resolved, engine fully initialised |
