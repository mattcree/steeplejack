...
| 3 | Install Unreal 5.5 somewhere and set `UE_ROOT` | the second half of CORE-001, and all of `SteeplejackGame` | ⬜ open |
...
|---|---|---|---|---|
| PROD-001 | 2026-09-16 | 2026-09-16 | Which engine? | Unreal 5.5, with `SteeplejackSim` as a UE-independent C++ module. [ADR-0004](docs/03-tech/adr/0004-engine-change-to-unreal.md). |
